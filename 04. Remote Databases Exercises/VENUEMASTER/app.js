...
import {venueTemplate, confirmationTemplate} from "./template.js";
...
function attachedEvents() {
    ...
    function createVenue(venue) {
        ...
        Array.from(html.venueInfoButton()).forEach(button => {
            button.addEventListener("click", showVenueInfo);
        });
    
        Array.from(html.venuePurchaseButton()).forEach(button => {
